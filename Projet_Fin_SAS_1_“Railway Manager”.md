...
Les données nécessaires à la réalisation du projet sont déjà fournies. Elles contiennent la liste des trajets à utiliser dans l’application.

Vous devez utiliser ces données comme base de travail.

**Données du projet:**  [https://gist.github.com/AzizBenMallouk/31e020b92fcc710a732fae0c2adec985](https://gist.github.com/AzizBenMallouk/31e020b92fcc710a732fae0c2adec985)
...
Les trajets sont **fixes** et déjà enregistrés dans le programme.

Il n’est pas demandé de créer ou de calculer de nouveaux trajets.
...
1. rechercher le trajet correspondant ;  
2. vérifier que le trajet existe ;  
3. vérifier qu'il reste au moins une place disponible ;  
4. créer un ticket ;  
5. attribuer automatiquement un numéro de place ;  
6. diminuer le nombre de places disponibles ;  
7. ajouter le ticket au tableau des tickets.
...
3. retrouver le trajet associé ;  
4. supprimer le ticket ;  
5. augmenter le nombre de places disponibles du trajet de 1.
...
L'utilisateur peut faire un filtrer par ville de départ
